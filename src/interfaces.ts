...
export interface TomtomResponseSummary {
  ...
  queryIntent: Array<any>
}

type TomtomResultType = 'POI' | 'Street' | 'Geography' | 'Point Address' | 'Address Range' | 'Cross Street';
...
export type GetPlaceResult = { placeId: string} & Subset<TomtomResultAddress, {
  streetNumber?: string,
  countryCode: string,
  country: string,
  freeformAddress: string,
